...
namespace LaboOefeningen
{
    ...
    internal class Arrays
    {
        public static void KeuzeMenu()
        {
            ...
            Console.WriteLine("1 - Oefening 1 - ArrayTrueFalse");
            Console.WriteLine("2 - Oefening 2 - ArrayOefener1");
            Console.WriteLine("3 - Oefening 3 - Boodschappenlijst");
            Console.WriteLine("4 - Oefening 4 - Lotto");
            Console.WriteLine("5 - Oefening 5 - IntegerIndexOf");
            Console.WriteLine("10 - Oefening 10 - ArrayTrueFalse_2");
            Console.WriteLine("11 - Oefening 11 - IntegerIndexOf");
            Console.WriteLine("12 - Oefening 12 - StringBinarySearch");
        ...
        public static void BoodschappenlijstList()
        {
            ...
            do
            {
                Console.WriteLine($"Wat is item {teller + 1} op je lijst?");
            ...
            Console.WriteLine("Naar huis met de boodschappen!");
            Console.WriteLine("Volgende items van je lijst ben je vergeten te kopen: ");
            foreach (string vergetenItems in items)
            {
                Console.Write(vergetenItems + " ");
            }
            Console.ReadKey();
        }
        ...
        public static void KerstinkopenList()
        {
            ...
            do
            {
                Console.WriteLine($"Wat is de prijs van cadeau {i}?");
                prijs = Convert.ToDouble(Console.ReadLine());
                cadeautjes.Add(prijs);
                i++;

                if (cadeautjes.Sum() > budget)
                {
                    Console.WriteLine($"Je bent al {cadeautjes.Sum() - budget} euro over het budget!");
                    Console.WriteLine("");
                }

            } while (prijs > 0 && cadeautjes.Sum() <= budget);

            cadeautjes.Sort();

            foreach (double cadeau in cadeautjes)
            {
                Console.WriteLine("- " + cadeau);
            }
